...
(min-width:1919.98px){url(' . $template_directory . '/img/hero-sect-img.2560.jpg)}';
    ...
    if ( is_page( 'category' ) ) {
      ...
      $category_descr = $queried_object->description . 'Свежие материалы от наших лучших авторов. Топовые материалы прямиком из-под пера.';
    } else {
...
<section class="hero-sect<?php echo $hero_sect_class ?> container lazy" data-src="<?php echo $hero_sect_datasrc ?>" data-media="<?php echo $hero_sect_datamedia ?>">
